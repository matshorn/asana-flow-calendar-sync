    ...
    <TaskProvider>
      <div className="min-h-screen flex flex-col dark:bg-gray-900">
        ...
        <main className="flex-1 flex flex-col md:flex-row overflow-hidden">
          {/* Task List Panel */}
          <div className="w-full md:w-1/3 lg:w-1/4 border-r border-gray-700 overflow-hidden flex flex-col dark:bg-gray-800">
            <TaskList />
          </div>
          
          {/* Calendar Panel */}
          <div className="w-full md:w-2/3 lg:w-3/4 flex flex-col dark:bg-gray-900">
            <Calendar />
          </div>
        </main>
      </div>
